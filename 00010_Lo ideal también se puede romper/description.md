Como en la definición de `hayBolitasAl` se usa `Mover`, es obvio que hay casos en los que podría romperse: basta con posicionar el cabezal en el origen y preguntar si `hayBolitas` de algún color al oeste.
