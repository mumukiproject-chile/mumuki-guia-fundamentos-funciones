Ahora te toca definir tu primera función: `todasExcepto(color)`. Lo que tiene que hacer es sencillo: contar cuántas bolitas hay en la celda actual **sin tener en cuenta** las del color recibido por parámetro.
